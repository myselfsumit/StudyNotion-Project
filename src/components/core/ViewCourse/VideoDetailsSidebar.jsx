...
// Assuming there's an action to update the completedLectures in the Redux store
...
export default function VideoDetailsSidebar({ setReviewModal }) {
  ...
  // Change handler for checkbox (to toggle completion status)
  const handleCheckboxChange = (topicId) => {
    dispatch(updateCompletedLectures(topicId));  // Dispatch the action to update the completion status
  };
  return (
                ...
                {course.subSection.map((topic) => (
                  ...
                  >
                    <input
                      ...
                      onChange={() => handleCheckboxChange(topic?._id)} // Proper change handler
                    />
                    {topic.title}
                  </div>
                ))}
